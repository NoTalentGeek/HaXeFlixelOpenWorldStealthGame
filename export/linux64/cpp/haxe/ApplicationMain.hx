...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "HaXeFlixelOpenWorldStealthGame", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "HaXeFlixelOpenWorldStealthGame";
		#end
		...
		flash.Lib.create (function () {
			...
			"HaXeFlixelOpenWorldStealthGame",
			null
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "HaXeFlixelOpenWorldStealthGame", null, { width: 640, height: 480 });
...
class ApplicationMain {
	...
	public static function main () {
		...
		config = {
			...
			build: "44",
			company: "HaxeFlixel",
			file: "HaXeFlixelOpenWorldStealthGame",
			fps: 60,
			name: "HaXeFlixelOpenWorldStealthGame",
			...
			windows: [
				
				{
					...
					resizable: true,
					stencilBuffer: false,
					title: "HaXeFlixelOpenWorldStealthGame",
					vsync: true,
					width: 640,
					x: null,
					y: null
